...
public class SimpleFacebook {
	 ...
	 * id of the profile: {@link com.sromku.simple.fb.entities.Profile#getId()}<br>
	 * - <b>Page</b>. It can be any page. To get the page id:
	 * {@link com.sromku.simple.fb.entities.Page#getId()}<br>
	 * <br>
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.sromku.simple.fb.Permission#USER_PHOTOS}<br>
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_PHOTOS}
	 * 
	 * @param entityId
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.sromku.simple.fb.Permission#USER_CHECKINS}<br>
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_CHECKINS}
	 * 
	 ...
	 * <br>
	 * The entity can be one of:<br>
	 * - <b>Album</b>. Any album. To get the album id: {@link com.sromku.simple.fb.entities.Album#getId()}<br>
	 * - <b>Checkin</b>. Any checkin. To get the checkin id:
	 * {@link com.sromku.simple.fb.entities.Checkin#getId()}<br>
	 * - <b>Comment</b>. Get all replied comments to this original comment. To
	 * get comment id: {@link com.sromku.simple.fb.entities.Comment#getId()} <br>
	 * - <b>Photo</b>. Any photo. To get the photo id: {@link com.sromku.simple.fb.entities.Photo#getId()} <br>
	 * - <b>Post</b>. Any post. To get the post id: {@link com.sromku.simple.fb.entities.Post#getId()} <br>
	 * - <b>Video</b>. Any video. To get the video id: {@link com.sromku.simple.fb.entities.Video#getId()} <br>
	 * <br>
	 * 
	 * <b>Permission:</b><br>
	 ...
	 * album, you need to have the {@link com.sromku.simple.fb.Permission#USER_PHOTOS} or
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_PHOTOS} for getting the comments of this album.
	 * 
	 * @param entityId
	 ...
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_EVENTS}
	 * 
	 * @param eventDecision
	 ...
	 * - <b>Profile</b>. It can be you, your friend or any other profile. To get
	 * id of the profile: {@link com.sromku.simple.fb.entities.Profile#getId()}<br>
	 * - <b>Page</b>. Any page. To get the page id: {@link com.sromku.simple.fb.entities.Page#getId()}<br>
	 * - <b>Group</b>. Any group. To get the group id: {@link com.sromku.simple.fb.entities.Group#getId()}<br>
	 * <br>
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.sromku.simple.fb.Permission#USER_EVENTS}<br>
	 ...
	 * {@link #getFriends(com.sromku.simple.fb.entities.Profile.Properties, OnFriendsRequestListener)} <br>
	 * <br>
	 * 
	 ...
	 *            The callback listener.
	 * @param properties
	 *            The {@link com.sromku.simple.fb.entities.Profile.Properties}. <br>
	 *            To create {@link com.sromku.simple.fb.entities.Profile.Properties} instance use:
	 * 
	 *            <pre>
	 ...
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_GROUPS}
	 * 
	 * @param entityId
	 *            Profile
	 * @param onGroupsListener
	 ...
	 * {@link com.sromku.simple.fb.entities.Comment#getId()} <br>
	 * - <b>Photo</b>. Any photo. To get the photo id: {@link com.sromku.simple.fb.entities.Photo#getId()} <br>
	 * - <b>Post</b>. Any post. To get the post id: {@link com.sromku.simple.fb.entities.Post#getId()} <br>
	 * - <b>Video</b>. Any video. To get the video id: {@link com.sromku.simple.fb.entities.Video#getId()} <br>
	 * <br>
	 ...
	 * album, you need to have the {@link com.sromku.simple.fb.Permission#USER_PHOTOS} or
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_PHOTOS} for getting likes of this album.
	 * 
	 * @param entityId
	 *            Album, Checkin, Comment, Link, Photo, Post or Video.
	 * @param onCommentsListener
	 ...
	 * The entity can be one of:<br>
	 * - <b>Album</b>. Any album. To get the album id: {@link com.sromku.simple.fb.entities.Album#getId()}<br>
	 * - <b>Event</b>. Any event. To get the event id: {@link com.sromku.simple.fb.entities.Event#getId()}<br>
	 * - <b>Page</b>. Any page. To get page id: {@link com.sromku.simple.fb.entities.Page#getId()} <br>
	 * - <b>Profile</b>. Any profile. To get profile id: {@link com.sromku.simple.fb.entities.Profile#getId()} <br>
	 * <br>
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.sromku.simple.fb.Permission#USER_PHOTOS}<br>
	 ...
	 * {@link #getProfile(com.sromku.simple.fb.entities.Profile.Properties, OnProfileRequestListener)} <br>
	 * <br>
	 ...
	 * {@link #getProfile(com.sromku.simple.fb.entities.Profile.Properties, OnProfileRequestListener)} and mention
	...
	/**
	 * Get posts of specific entity filtered by {@link com.sromku.simple.fb.entities.Post.PostType}.<br>
	 * 
	 * <br>
	 * In case of:
	 * 
	 * <pre>
	 * {@link com.sromku.simple.fb.entities.Post.PostType#ALL}
	 * </pre>
	 * 
	 * the entity can be one of:<br>
	 * - <b>Group</b>. Any group. To get the group id: {@link com.sromku.simple.fb.entities.Group#getId()}<br>
	 ...
	 * 
	 * <pre>
	 * 	{@link com.sromku.simple.fb.entities.Post.PostType#LINKS}
	 * 	{@link com.sromku.simple.fb.entities.Post.PostType#POSTS}
	 * 	{@link com.sromku.simple.fb.entities.Post.PostType#STATUSES}
	 * 	{@link com.sromku.simple.fb.entities.Post.PostType#TAGGED}
	 * </pre>
	 * 
	 * the entity can be one of:<br>
	 * - <b>Page</b>. Any page. To get page id: {@link com.sromku.simple.fb.entities.Page#getId()} <br>
	 ...
	 * {@link com.sromku.simple.fb.Permission#FRIENDS_VIDEOS}
	 * 
	 * @param entityId
	 *            Profile, Page, Event
	 * @param onVideosListener
	 ...
	 * 
	 * @param feed
	 *            The feed to publish. Use {@link com.sromku.simple.fb.entities.Feed.Builder} to create a new
	 *            <code>Feed</code>
